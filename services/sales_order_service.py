"""
Sales Order domain service for the Sales Order (`oldso`) flow.
"""
...
from scripts.m18_sales_order_api import (  # noqa: E402
    M18SalesOrderAPI,
    build_draft_line,
...
class M18SalesOrderService:
    """Business service for sales order actions."""
    ...
    def search_sales_orders(
        ...
        return self.sales_order_api.search(
            be_id=be_id,
    ...
    def load_sales_order(self, record_id: int, irev: Optional[int] = None) -> Dict[str, Any]:
        return self.sales_order_api.load(record_id, irev=irev)
    ...
    def create_draft_from_codes(
        ...
        return self.sales_order_api.create_draft_by_codes(
            be_code=be_code,
            cus_code=cus_code,
            lines=draft_lines,
    ...
    def save_sales_order(
        ...
        return self.sales_order_api.save(
